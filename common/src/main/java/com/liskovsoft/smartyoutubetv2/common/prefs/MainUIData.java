...
public class MainUIData extends DataChangeBase implements ProfileChangeListener {
    ...
    public static final long MENU_ITEM_OPEN_IN_SUBSCRIPTIONS = 1L << 37;
    ...
    public static final long MENU_ITEM_DEFAULT = MENU_ITEM_PIN_TO_SIDEBAR | MENU_ITEM_NOT_INTERESTED | MENU_ITEM_NOT_RECOMMEND_CHANNEL |
            ...
            MENU_ITEM_OPEN_IN_SUBSCRIPTIONS;
    private static final Long[] MENU_ITEM_DEFAULT_ORDER = {
            ...
            MENU_ITEM_OPEN_IN_SUBSCRIPTIONS, MENU_ITEM_STREAM_REMINDER, MENU_ITEM_RECENT_PLAYLIST, MENU_ITEM_ADD_TO_PLAYLIST, MENU_ITEM_CREATE_PLAYLIST, MENU_ITEM_RENAME_PLAYLIST,
